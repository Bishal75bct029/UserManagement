...
<div class="max-w-md mx-auto bg-white rounded p-8 shadow mt-8">
  ...
  <form action="/addData" method="POST">
    ...
    <div class="mb-4">
      ...
      <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" type="text" placeholder="Enter your name" name="name">
      @if($errors->has('name'))
    ...
    <div class="mb-4">
      ...
      <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="address" type="text" placeholder="Enter your Address" name="address">
    ...
    <div class="mb-4">
      ...
      <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="postal-code" type="number" placeholder="Enter your postal code" name="postalcode">
